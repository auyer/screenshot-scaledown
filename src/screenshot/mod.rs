//! This code was copied from an unmaintained library, with various improvements 
//! manually merged from other forks, and some manual tweaks from my own.
//! The original library is located here: github.com/alexchandel/screenshot-rs
...
pub use self::ffi::get_screenshot;
use std::mem::size_of;
    ...
    pub fn get_pixel(&self, row: usize, col: usize) -> Pixel {
        ...
        unsafe {
            ...
            if idx > self.data.len() {
                panic!("Bounds overflow. idx: {}, len: {}", idx, self.data.len());
            }
